...
if resp_file and screen_file:
    try:
        ...
        if st.button("🚀 Run Full Audit"):
            ...
            with tabs[2]:
                search = st.text_input("Search ID to Review/Force Check Phone:")
